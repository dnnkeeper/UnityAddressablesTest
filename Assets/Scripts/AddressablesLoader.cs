...
namespace AddressablesTest
{
    ...
    {
        public string assetName = "NewObject";

        AsyncOperationHandle<GameObject> downloadOperation;
        ...
        IEnumerator LoadRoutine()
        {
            ...
            downloadOperation = Addressables.LoadAsset<GameObject>(assetName);
        ...
        private void DownloadOperation_Completed(AsyncOperationHandle<GameObject> operation)
        {
            ...
            else
            {
                ...
                GameObject.Instantiate(operation.Result.gameObject, transform.position, transform.rotation);
            }
        }
